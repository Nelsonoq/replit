...
//           .setRequired(true)
//           .setAutocomplete(true), // ✅ AUTOCOMPLETE ativado
//     )
...
//     // Filtra timezones baseado no que o user está a escrever
//     const filtered = ALL_TIMEZONES.filter((tz) =>
//       tz.toLowerCase().includes(focusedValue),
//     ).slice(0, 25); // Discord só permite 25 resultados
...
//       return interaction.reply({
//         content: `❌ Invalid date! Month ${month} only has ${diasPorMes[month - 1]} days.`,
//         flags: 64,
//       });
//     }
...
//     if (existingIndex !== -1) {
//       // Já existe - mostrar aviso e NÃO atualizar
//       const embed = new EmbedBuilder()
//         .setColor(0xff0000) // Vermelho para erro
//         .setDescription(
//           `❌ ${user}, you already have a birthday setup on this server!\nRemove it using \`/remove-birthday\``
//         )
//         .setTimestamp();
...
//     // Adicionar novo aniversário (só executa se NÃO existir)
//     birthdays.push({
//       userId: user.id,
